...
Namespace CelebrityBirthdayDataSetTableAdapters
    ...
    Partial Public Class DatesTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.cbdescupdate.My.MySettings.Default.CelebrityBirthdayConnectionString
        End Sub
    ...
    Partial Public Class PersonTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([id] = @Original_id) AND ((@IsNull_forename = "& _ 
                ...
                "ortdesc] = @Original_shortdesc)) AND ((@IsNull_imgfilename = 1 AND [imgfilename]"& _ 
                " IS NULL) OR ([imgfilename] = @Original_imgfilename)) AND ((@IsNull_imgfiletype "& _ 
                "= 1 AND [imgfiletype] IS NULL) OR ([imgfiletype] = @Original_imgfiletype)) AND ("& _ 
                "[sortseq] = @Original_sortseq) AND ((@IsNull_dateadded = 1 AND [dateadded] IS NU"& _ 
                "LL) OR ([dateadded] = @Original_dateadded)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_id", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([forename], [surname], [birthyear], [birthmonth], [bi"& _ 
                "rthday], [deathyear], [shortdesc], [longdesc], [imgfilename], [imgfiletype], [so"& _ 
                "rtseq], [dateadded]) VALUES (@forename, @surname, @birthyear, @birthmonth, @birt"& _ 
                "hday, @deathyear, @shortdesc, @longdesc, @imgfilename, @imgfiletype, @sortseq, @"& _ 
                "dateadded);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, forename, surname, birthyear, birthmonth, birthday, deat"& _ 
                "hyear, shortdesc, longdesc, imgfilename, imgfiletype, sortseq, dateadded FROM Pe"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Person] SET [forename] = @forename, [surname] = @surname, [birthyea"& _ 
                ...
                " = @deathyear, [shortdesc] = @shortdesc, [longdesc] = @longdesc, [imgfilename] ="& _ 
                " @imgfilename, [imgfiletype] = @imgfiletype, [sortseq] = @sortseq, [dateadded] ="& _ 
                " @dateadded WHERE (([id] = @Original_id) AND ((@IsNull_forename = 1 AND [forenam"& _ 
                "e] IS NULL) OR ([forename] = @Original_forename)) AND ([surname] = @Original_sur"& _ 
                "name) AND ([birthyear] = @Original_birthyear) AND ([birthmonth] = @Original_birt"& _ 
                "hmonth) AND ([birthday] = @Original_birthday) AND ([deathyear] = @Original_death"& _ 
                "year) AND ((@IsNull_shortdesc = 1 AND [shortdesc] IS NULL) OR ([shortdesc] = @Or"& _ 
                "iginal_shortdesc)) AND ((@IsNull_imgfilename = 1 AND [imgfilename] IS NULL) OR ("& _ 
                "[imgfilename] = @Original_imgfilename)) AND ((@IsNull_imgfiletype = 1 AND [imgfi"& _ 
                "letype] IS NULL) OR ([imgfiletype] = @Original_imgfiletype)) AND ([sortseq] = @O"& _ 
                "riginal_sortseq) AND ((@IsNull_dateadded = 1 AND [dateadded] IS NULL) OR ([datea"& _ 
                "dded] = @Original_dateadded)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, forename, surname, birthyear, birthm"& _ 
                "onth, birthday, deathyear, shortdesc, longdesc, imgfilename, imgfiletype, sortse"& _ 
                "q, dateadded FROM Person WHERE (id = @id)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, forename, surname, birthyear, birthmonth, birthday, deathyear, shortde"& _ 
                "sc, longdesc, imgfilename, imgfiletype, sortseq, dateadded FROM dbo.Person"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        id, forename, surname, birthyear, birthmonth, birthday, deathyear, "& _ 
                "shortdesc, longdesc, imgfilename, imgfiletype, sortseq, dateadded"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         "& _ 
                "   Person"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (forename LIKE @forename) AND (surname LIKE @surname) AN"& _ 
                "D (birthmonth = @month) AND (birthday = @day)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(2).CommandText = "UPDATE       Person"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET                longdesc = @longdesc"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (id = "& _ 
                "@Id); "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, forename, surname, birthyear, birthmonth, birthday, deathyear"& _ 
                ", shortdesc, longdesc, imgfilename, imgfiletype, sortseq, dateadded FROM Person "& _ 
                "WHERE (id = @Id)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@longdesc", Global.System.Data.SqlDbType.NVarChar, 2147483647, Global.System.Data.ParameterDirection.Input, 0, 0, "longdesc", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByNameDate(ByVal dataTable As CelebrityBirthdayDataSet.PersonDataTable, ByVal forename As String, ByVal surname As String, ByVal month As Integer, ByVal day As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            ...
            Me.Adapter.SelectCommand.Parameters(3).Value = CType(day,Integer)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
            Dim returnValue As Integer = Me.Adapter.Fill(dataTable)
        ...
        Public Overloads Overridable Function UpdateLongDesc(ByVal longdesc As String, ByVal Id As Integer) As Integer
            Dim command As Global.System.Data.SqlClient.SqlCommand = Me.CommandCollection(2)
            If (longdesc Is Nothing) Then
                command.Parameters(0).Value = Global.System.DBNull.Value
            Else
                command.Parameters(0).Value = CType(longdesc,String)
            End If
